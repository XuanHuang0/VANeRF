...
import cv2
import numpy as np
from utils.inter_config import cfg
import random
import math
...
# def augmentation(img,mask, bbox, joint_coord, joint_valid,mano_valid, vert, hand_type, mode, joint_type, vert_type, focal, princpt):
